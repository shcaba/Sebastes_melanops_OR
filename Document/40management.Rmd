...
This stock assessment is specifically for `r spp` in state and federal waters off Oregon.  As such, no specific regional management considerations and associated documentation is anticipated to be required. Seperate stock assessments conducted in 2023 for `r spp` off of California and Washington can be found on the Pacific Fishery Management Council [website](https://www.pcouncil.org/stock-assessments-star-reports-stat-reports-rebuilding-analyses-terms-of-reference/groundfish-stock-assessment-documents/).
