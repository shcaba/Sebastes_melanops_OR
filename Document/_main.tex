...
\item
  Continue work on the investigation into the movement, behavior or mortality of older (\textgreater{} age 10) females to further reconcile their absence in fisheries data. In particular, conduct genetics studies on fish observed off of the continental shelf (middle of the gyere and at sea mounts) to determine their association with the nearshore stocks.
\item
...
\item
  Design and conduct research studies to better understand the tradeoffs revealed in this assessment between Black Rockfish biology and population scale that seem be at odds. If discrepencies can not be uncovered, evalute management procedures that are as robust as can be to this tradeoff.
\item
