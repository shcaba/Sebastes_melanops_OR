...
\hypersetup{
  pdftitle={Status of Black rockfish (Scientific name) along the US West coast in 2022},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Status of Black rockfish (\emph{Scientific name}) along the US West coast in 2022}
\newcommand{\trYear}{2022}
\newcommand{\trMonth}{November}
\newcommand{\trAuthsLong}{true}
\newcommand{\trAuthsBack}{Cope, J.M}
\newcommand{\trCitation}{
...
\noindent
\begin{center}
\title{Status of Black rockfish (\emph{Scientific name}) along the US West coast in 2022}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Status of Black rockfish (\emph{Scientific name}) along the US West coast in 2022}}
\vfill
by\\
Jason M. Cope\textsuperscript{1}\vfill
