...
\bigskip
\noindent
Pictured on the title page are Mark Terwilliger (ODFW; left) and Laurie Weitkamp (NWFSC; right) displaying Black Rockfish landed during research surveys. Photo credits: Leif Rasmuson (left) and NOAA (right).
\clearpage
