...
\begin{figure}
\centering
\includegraphics[width=0.2\textwidth,height=0.2\textheight]{C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_OR/Document/figures/brf photos/large_female_BLK.jpg}
...
\hypertarget{on-board-observer-cpue-for-oregon-2001-and-2003-to-2022---ali-to-update}{%
\paragraph{On-Board Observer CPUE for Oregon, 2001 and 2003 to 2022 - Ali to update}\label{on-board-observer-cpue-for-oregon-2001-and-2003-to-2022---ali-to-update}}
...
\item
  ...
  \item
    Tag survey q = to 2015 value (0.25)
  \item
    Tag survey q = to 2015 value (0.25), but extra variance estimated
  \end{enumerate}
\item
...
\item
  ...
  \item
    ...
    \item
      Estimate recruitment for all years in the model Miscellaneous
    \end{enumerate}
  \end{itemize}
  ...
  \tightlist
  \item
    Estimate logistic selectivity for all fleets
  \end{enumerate}
\end{itemize}
