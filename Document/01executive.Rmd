...
5. Design and conduct research studies to better understand the tradeoffs revealed in this assessment between `r spp` biology and population scale that seem be at odds. If discrepencies can not be uncovered, evalute management procedures that are as robust as can be to this tradeoff.
