...
caption = "Functional maturity of black rockfish based on fish sample in Oregon.",
...
caption = "Biological maturity of black rockfish based on fish sample in Oregon.",
label = 'lt _rec_samples')
