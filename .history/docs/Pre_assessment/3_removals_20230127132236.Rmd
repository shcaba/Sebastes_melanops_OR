...
When providing data to the 2015 Black rockfish assessment, ODFW staff noted that trawl landings from the 1940s to the 1980s had high year to year variability and an unreasonable magnitude of landings in some years. These data were from the then newly completed [Karnowski et al (2014)](https://www.dfw.state.or.us/mrp/publications/docs/ODFW_Info_Rpt%202014-02_Historic_Reconstruction_Oregon_Commercial_Fish_Landings.pdf) catch reconstruction. ODFW provided an alternative time series that was eventually used in the 2015 assessment (P. Mirick (ODFW) was the main source of this reconstruction). Additionally, the Karnowski et al. (2014) reconstruction did not account for fish taken off of Washington but landed into Oregon, specifically Astoria port landings. The Mirick reconstruction substantially reduced the magnitude of historic trawl catches and stabilized interannual variation in landings compared to the Karnowski et al. (2014) reconstruction.
