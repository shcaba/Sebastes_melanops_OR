...
- Treatment of absolute abundance catchability (q) 
	1. Acoustic visual survey q = 1, CV = 0.0001
  	...
  	4. Acoustic visual survey q = 1, CV = 0.45
  	5. Acoustic visual survey q estimated, CV = 0.45
  	6. Tag survey q = to 2015 value (0.25)
  	7. Tag survey q = to 2015 value (0.25), but extra variance estimated
