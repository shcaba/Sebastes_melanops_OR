...
caption = "Relative spawning output time series by data treatment compared to the reference model. Each scenario is labelled to indicate what data are being used in the scenario. For instance, 'Catch Lengths' is a model with catch and lengths only. 'Dome' referes to a dome-shaped selectivity option for all fisheries",
...
caption = "Spawning output (in millions of eggs) time series by data treatment compared to the reference model. Each scenario is labelled to indicate what data are being used in the scenario. For instance, 'Catch Lengths' is a model with catch and lengths only. 'Dome' referes to a dome-shaped selectivity option for all fisheries",
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc, "Piner_like_comps.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc, "LC_Lt.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc, "LC_age.png"), 
...
```{r, results = 'asis'}
add_figure(
filein = file.path(likeprof_fig_loc, "LC_survey.png"), 
