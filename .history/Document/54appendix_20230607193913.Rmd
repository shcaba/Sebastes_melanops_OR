...
plot.vec = plot.vec[find[2:length(find)]]
filein = file.path(mod_loc, "plots")
cap.in=c("Trawl conditional AAL plot (plot 1 of 8) showing mean age (left panel) and standard deviation (right panel. Shaded areas are 90 percent CIs)",
"Trawl conditional AAL plot (plot 2 of 8)",
