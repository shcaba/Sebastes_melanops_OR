...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sensi_data_fig_loc, "pre-STAR/Sensi_logREplot_SB_Dep_F_Yield.png"),
...
```{r, echo=FALSE, results='asis'}
add_figure(
filein = file.path(sensi_modspex_fig_loc, "pre-STAR/Sensi_logREplot_SB_Dep_F_Yield.png"),
