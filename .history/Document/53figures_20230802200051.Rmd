...
caption = "Maturity as a function of length (cm) used in the base model",
label = 'maturity')
```
...
caption = "Fecundity (kg) as a function of length (cm) used in the base model",
label = 'fecundity')
```
...
caption = "The set of standardized indices (each index is scaled to have a mean observation of 1) used in the base model.",
label = 'sur-summ-all')
```
...
caption = "Log relative change (log((Model_sensi-Model_ref)/Model_ref)) in data treatment for 5 derived quantities. Colored boxes indicate 95 percent confidence interval of the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
...
caption = "Spawning output (in millions of eggs) time series by data treatment compared to the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
...
caption = "Relative spawning output time series by data treatment compared to the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
...
caption = "Log relative change (log((Model_sensi-Model_ref)/Model_ref)) in model specification scenario for 5 derived quantities. Colored boxes indicate 95 percent confidence interval of the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
...
caption = "Spawning output (in millions of eggs) time series by model specification scenario compared to the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
...
caption = "Relative spawning output time series by model specification scenario compared to the pre-STAR reference model. See 'Sensitivity Analysis' section for more details on each scenario",
