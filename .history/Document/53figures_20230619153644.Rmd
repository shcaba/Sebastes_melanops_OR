...
caption = "Index of recruitment from SMURF data collections. Error bars indicate 95% uncertainty interval around index values based on the model assumption of lognormal error.",
...
```{r, results = 'asis'}
add_figure(
filein = file.path(manage_loc, "yield2_yield_curve_with_refpoints.png"), 
caption = "Time series of spawning output (with 95% uncertainty envelops) for three states of nature, based on the treatment of the acpustic visual survey catchability, of Oregon black rockfish",
...
add_figure(
filein = file.path(manage_loc, "yield2_yield_curve_with_refpoints.png"), 
caption = "Time series of relative stock status (with 95% uncertainty envelops) for three states of nature, based on the treatment of the acpustic visual survey catchability, of Oregon black rockfish",
