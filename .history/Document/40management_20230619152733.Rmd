...
Given the desire for states of nature to represent uncertainty in both scale and relative status of the stock, the treatment of the acoustic visual survey q, either being estimated by the model or being fixed to a value of 1, offer an appropriate range of uncertainty in the current status and trend of `r spp` in Oregon. Figure \ref{fig:} present the three states of nature  
