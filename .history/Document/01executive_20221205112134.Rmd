...
#The model-estimated uncertainty around the `r endyr+1` spawning biomass was $\sigma$ = `r round 
#(model$Pstar_sigma,2)` and the #uncertainty around the OFL was $\sigma$ = `r round(model$OFL_sigm, 2)`. #This is likely an underestimate of overall uncertainty #because of the necessity to fix some parameters #such as steepness, as well as a lack of explicit incorporation of model structural #uncertainty.
