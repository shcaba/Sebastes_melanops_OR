...
A flexible spline model can capture skipped spawning in the maturity ogive by allowing a decreased asymptote from 1.0. There was evidence of skipped spawning in larger size classes and so the flexible spline model was determined to be the best representation of the reproductive biology of Black Rockfish for the sampled time period (Figure \ref{fig:bio-fxn-mat-color}). The tail of the flexible spline model was driven down by a small sample size, so, for the assessment, we used a constant value equal to the peak of the curve for the larger size classes. 
