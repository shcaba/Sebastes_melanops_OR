...
```{r, results='asis'}
mod_loc = file.path("C:/Users/Jason.Cope/Documents/Github/Sebastes_melanops_OR/Document/models",
   base_name)
plot_info = read.csv(file.path(mod_loc, "plots", "plotinfotable_for_doc.csv"))
...
plot.vec = c(grep("comp_condAALfit_Andre_plotsflt1mkt0", age_fit$label),
			 ...
			 grep(comp_condAALfit_Andre_plotsflt3mkt0))
...
"Commerical conditional AAL plot (plot 3 of 5)",
"Commerical conditional AAL plot (plot 4 of 5)",
"Commerical conditional AAL plot (plot 5 of 5)",
"Recreational conditional AAL plot (plot 1 of 7) showing mean age (left panel) and standard deviation (right panel. Shaded areas are 90 percent CIs)",
"Recreational conditional AAL plot (plot 2 of 7)",
"Recreational conditional AAL plot (plot 3 of 7)",
"Recreational conditional AAL plot (plot 3 of 7)",
"Recreational conditional AAL plot (plot 4 of 7)",
"Recreational conditional AAL plot (plot 5 of 7)",
"Recreational conditional AAL plot (plot 6 of 7)",
"Recreational conditional AAL plot (plot 7 of 7)"
	)
