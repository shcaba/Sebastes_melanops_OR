...
The Oregon model faced many challenges and ultimately was re-evaluated in a secondary review panel. That panel noted the following issues and recommendations.

* Consider weighting conditional age at length data
* The lack of recruitment estimation should be re-evaluated despite the last assessment indicating no apparent information contained in the biological data as to notable recruitment deviations. 
* 


Many of these are included in the prior assessments recommended areas of uncertainty. In addition to 
